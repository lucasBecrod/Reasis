...
## Registro de reorganización 2025-08-11

- Se ejecutó `scripts/reorganizar_raiz.py` para limpiar el directorio raíz:
  - Archivos `.md` del raíz movidos a `docs/`.
  - Archivos `.sql` del raíz movidos a `db/sql/`.
- Beneficio: raíz más limpio; documentación centralizada en `docs/`; scripts SQL agrupados en `db/sql/`.
- Nota: revisar y actualizar enlaces relativos en documentación que apuntaban a archivos `.md` en el raíz.