...
# For simplicity, re-run the aggregation logic here
...
# Merge dataframes
# Ensure 'id_red_fya' is numeric for merging
df_instituciones['id_red_fya'] = pd.to_numeric(df_instituciones['id_red_fya'], errors='coerce')

df_merged = pd.merge(df_instituciones, aggregated_data, left_on='id_red_fya', right_on='red_number', how='left')
