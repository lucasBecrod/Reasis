...
# -*- coding: utf-8 -*-
"""
Consolidador Final - Proyecto Reasis
Script que explora los datos y luego los consolida correctamente
"""
...
def explorar_datos():
    """Explora los datos para entender la estructura"""
    ...
    try:
        ...
        print(f"❌ Error explorando datos: {e}")
        return None
...
def procesar_competencia_digital_docentes(conn, df):
...
def main():
    """Función principal"""
    print("🚀 CONSOLIDADOR FINAL - PROYECTO REASIS")
    print("=" * 60)
    
    # Paso 1: Explorar datos
    df = explorar_datos()
    if df is None:
        print("❌ No se pudieron explorar los datos")
        return
    
    # Paso 2: Crear base de datos
    conn = crear_base_datos()
    
    # Paso 3: Procesar competencia digital docentes
    procesar_competencia_digital_docentes(conn, df)
